<template>
    <div id="app">
        ...
        <navBar></navBar>
            ...
            <v-container class=" fluid customRow mb-5">
                <v-card v-for="(card, idx) in cards" cols="12" sm="4" :key="idx" class='columnBox' :style="{backgroundImage:`url(${card.src})` }">
                    <router-link :to="card.routes">
                        <div class="inner">
                            <img :src="card.logo" class='logo' >
                            <p class="boxTitle">
                                {{card.title}}
                            </p>
                        </div>
            ...
            <v-layout class="hidden-sm-and-down" row justify-center align="center" style="height: 400px;">
                <v-flex xs4 md3 style="margin-top: 70px; margin-left: -90px">
                    <a href="https://www.facebook.com/clearviewstats/" style="text-decoration:none">
                        <v-icon large style="margin-bottom: 17px; margin-top: 8px;" color="white">fab fa-facebook</v-icon>
                    </a><br>
                    <a href="https://twitter.com/CVR_Insights" style="text-decoration:none">
                        <v-icon large style="margin-bottom: 17px;" color="white">fab fa-twitter</v-icon></a><br>
                    <a href="https://www.instagram.com/clearviewstats/" style="text-decoration:none">
                        <v-icon large style="margin-bottom: 17px;" color="white">fab fa-instagram</v-icon></a><br>

                    <a href="https://www.linkedin.com/company/clearview-research-ltd" style="text-decoration:none">
                        <v-icon large style="margin-bottom: 17px;" color="white">fab fa-linkedin</v-icon></a>
                </v-flex>
                <v-flex xs8 md9 style="background:#1c1c1c; text-align: left; margin-top: 70px; margin-left: -40px">
                    ...
                    <v-img style="height: 2px; width: 220px; margin-top: -20px" :src="require('../assets/Line10.png')"></v-img><br>
                    ...
                    <p style="color:white; font-size: 13px"><strong>ClearView Research Ltd © 2021 All Rights Reserved | <span style="color: #d05e32"><a style="color: inherit; " href="./../static/privacy.pdf" target="_blank"> Privacy Policy</a></span></strong></p>

                </v-flex>
            </v-layout>
            <v-layout class="hidden-md-and-up" row justify-center align="center" style="height: 430px; background:#1c1c1c;">
                ...
                <v-flex xs12 md9 style="background:#1c1c1c; text-align: left; margin-top: 70px; margin-left: -40px">
                    ...
                    <v-img style="height: 2px; width: 200px; margin-top: -20px" :src="require('../assets/Line10.png')"></v-img><br>
                    ...
                    <p style="color:white; font-size: 14px"><strong>ClearView Research Ltd,<br>
                        86-90 Paul Street, London, EC2A 4NE</strong></p>
                    <p style="color:white; font-size: 14px"><strong>ClearView Research Ltd © 2021 All Rights Reserved | <span style="color: #d05e32"><a style="color: inherit; " href="./../static/privacy.pdf" target="_blank"> Privacy Policy</a></span></strong></p>
...
export default {
  ...
  data () {
    return {
      ...
      cards: [
        {
          ...
          routes: '/wdp',
          title: 'Westminster Drug Project (WDP)',
          src: require('../assets/case-studies/grid/1.jpg'),
          logo: ''
        },
        {

          routes: '/youth-employment',
          title: 'Youth Employment 2030 (YE2030)',
          src: require('../assets/case-studies/grid/2.jpg'),
          logo: ''
        },
        {
          routes: '/ygam',
          title: 'Young Gamers & Gamblers Education Trust (YGAM)',
          src: require('../assets/case-studies/grid/3.jpg'),
          logo: ''
        },
        {
          routes: '/human-rights',
          title: 'Parliamentary Joint Committee on Human Rights',
          src: require('../assets/case-studies/grid/4.jpg'),
          logo: ''
        },
        {
          routes: '/bite-black',
          title: 'Bite Back 2030',
          src: require('../assets/case-studies/grid/5.jpg'),
          logo: ''
        },
        {
          routes: '/gambleAware',
          title: 'GambleAware',
          src: require('../assets/case-studies/grid/6.jpg'),
          logo: ''
        },
        {
          routes: '/unicef-uk',
          title: 'UNICEF UK',
          src: require('../assets/case-studies/grid/7.jpg'),
          logo: ''
        },
        {
          routes: '/nhs-england',
          title: 'NHS England',
          src: require('../assets/case-studies/grid/8.jpg'),
          logo: ''
        },
        {
          routes: '/kings-college',
          title: 'Kings College London University',
          src: require('../assets/case-studies/grid/9.jpg'),
          logo: ''
        },
        {
          routes: '/early-years-foundation',
          title: 'London Early Years Foundation',
          src: require('../assets/case-studies/grid/10.jpg'),
          logo: ''
        },
        {
          routes: '/starbucks-uk',
          title: 'Starbucks UK',
          src: require('../assets/case-studies/grid/11.jpg'),
          logo: ''
        },
        {
          routes: '/uk-youth',
          title: 'UK Youth',
          src: require('../assets/case-studies/grid/12.jpg'),
          logo: ''
        },
        {
          routes: '/youth-cymru',
      ...
      navbarOptions: {
        ...
        brandImage: require('../assets/plogoc.png'),
        brandImagePath: './',
        brandImageAltText: 'brand-image',
        showBrandImageInMobilePopup: true,
        ariaLabelMainNav: 'Main Navigation',
        collapseButtonImageOpen: require('../assets/newmenu1.png'),
  ...
  mounted () {
    if (window.location.toString().includes('casestudies')) {
...
<style lang="css" scoped>
    ...
    .first-title{
        font-size:22px; color: #333680;  margin-left: 74px; margin-top: 0; margin-bottom: 100px;
    }

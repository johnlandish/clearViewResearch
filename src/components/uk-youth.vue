<template lang="html">
    <div id="app">
        ...
        <section class="mt-4 cover">
            <img src="../assets/case-studies/grid/12.jpg" style="width:100%; height:auto;">
        </section>
        <v-container style="margin-top:50px;" class="animate">
            <v-layout row wrap >
                <v-flex md12 sm12 class="px-4" style="text-align: left;">
                    <p style="font-size: 1.4rem; font-weight: bold;">UK Youth</p>

                </v-flex>
                <v-flex md12 sm12 class="px-4">
                    <p style="color: black; text-align: left; font-size: 28px;">
                        We were commissioned by UK Youth, who are the largest national body for the youth sector,
                        to conduct a comprehensive study over a duration of 9 months. Our research focused on
                        understanding the social impact of youth groups across the UK today and their sustainability
                        in the youth sector.
                    </p>

                    <p class="mt-5" style="text-align: left; margin-right: 50px; font-size: 28px;">AAs part of the study we conducted one of the largest national surveys of youth workers (that
                        resulted in nearly 800 respondents), case study visits to different types of youth groups
                        across the UK and interviews with young people (both 1-to-1 and focus groups), as well as
                        the youth workers at these youth groups.
                        We also held interviews with key stakeholders (funding bodies, chief executives of local and
                        national youth organisations) and local residents where youth clubs were based.
                        <br> Please find a downloadable copy of our report here: Local Youth Groups Today: The Value,
...
export default {
  ...
  mounted () {
    if (window.location.toString().includes('uk-youth')) {

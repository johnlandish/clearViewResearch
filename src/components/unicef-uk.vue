<template lang="html">
    <div id="app">
        ...
        <section class="mt-4 cover">
            <img src="../assets/case-studies/grid/7.jpg" style="width:100%; height:auto;">
        </section>
        <v-container style="margin-top:50px;" class="animate">
            <v-layout row wrap >
                <v-flex md12 sm12 class="px-4" style="text-align: left;">
                    <p style="font-size: 1.4rem; font-weight: bold;">UNICEF UK
                    </p>

                </v-flex>
                <v-flex md12 sm12 class="px-4">
                    <p style="color: black; text-align: left; font-size: 28px;">
                        We were commissioned to conduct an insight study on behalf of Unicef UK, to gather
                        in-depth insights from children and young people living in the UK aged between 10 and 20
                        about their habits and behaviour online and offline; their behaviour around sharing content;
                        their views on children’s rights and their understanding of UNICEF UK.
                    </p>

                    <p class="mt-5" style="text-align: left; margin-right: 50px; font-size: 28px;">As part of this
                        pAs part of this project we conducted 4 exploration labs and a nationwide survey, which had
                        over 850 respondents. The insights from this research assisted the youth strategy team to
                        develop more productive and meaningful ways for children and young people to contribute to
                        Unicef UK’s organisational priorities.
                    </p>
                </v-flex>
            </v-layout>
        </v-container>
...
export default {
  ...
  mounted () {
    if (window.location.toString().includes('unicef-uk')) {

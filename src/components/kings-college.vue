<template lang="html">
    <div id="app">
        ...
        <section class="mt-4 cover">
            <img src="../assets/case-studies/grid/9.jpg" style="width:100%; height:auto; transform: translateY(-60%);">
        </section>
        <v-container style="margin-top:50px;" class="animate">
            <v-layout row wrap >
                <v-flex md12 sm12 class="px-4" style="text-align: left;">
                    <p style="font-size: 1.4rem; font-weight: bold;">King's College London University</p>

                </v-flex>
                <v-flex md12 sm12 class="px-4">
                    <p style="color: black; text-align: left; font-size: 28px;">
                        We were commissioned to conduct an insight study on behalf of King's College University
                        (KCL). KCL commissioned ClearView to gain insight into the thoughts, perceptions and
                        attitudes of Caribbean students in regards to university choices. As part of this research we
                        did 5 exploration labs and 10 in-depth interviews in a matter of a couple of weeks.</p>
...
export default {
  ...
  mounted () {
    if (window.location.toString().includes('kings-college')) {

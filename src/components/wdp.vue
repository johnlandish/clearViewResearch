            ...
            <v-layout row wrap >
                ...
                <v-flex md12 sm12 class="px-4">
                    <p style="color: black; text-align: left; font-size: 28px;">
                        WDP is a leading provider of substance misuse related services. We were recently
                    ...
                    <p class="mt-5" style="text-align: left; margin-right: 50px; font-size: 28px;">The second project was a cultural audit. As part of this cultural audit our team explored the
                        ...
                        work. The insights provided from our audit will feed into WDP’s new strategy for 2021 - 2024.
                    </p>
                </v-flex>
            </v-layout>
        </v-container>
...
export default {
  ...
  mounted () {
    if (window.location.toString().includes('wdp')) {
